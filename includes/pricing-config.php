<?php
// Liwonde Sun Hotel - Pricing Configuration
// This file contains all pricing information for easy management
...
function getRoomName($roomType) {
    ...
    return ucfirst(str_replace('_', ' ', $roomType)) . ' Room';
}
...
// Function to get all room prices
function getAllRoomPrices() {
    global $roomPrices;
    $prices = [];
    foreach ($roomPrices as $type => $details) {
        $prices[$type] = $details['price'];
    }
    return $prices;
}
?>